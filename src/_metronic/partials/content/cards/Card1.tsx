  ...
  return (
    <div className='card'>
      <div className='card-body d-flex flex-center flex-column p-9'>
        ...
        <div className='fw-semibold text-gray-400 mb-6'>{job}</div>

        <div className='d-flex flex-center flex-wrap mb-5'>
          <div className='border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 mx-3 mb-3'>
            <div className='fs-6 fw-bold text-gray-700'>{avgEarnings}</div>
          ...
          <div className='border border-gray-300 border-dashed rounded min-w-125px py-3 mx-3 px-4 mb-3'>
            <div className='fs-6 fw-bold text-gray-700'>{totalEarnings}</div>
            <div className='fw-semibold text-gray-400'>Total Sales</div>
          </div>
        </div>

        <button className='btn btn-sm btn-light-primary fw-bold' id='kt_drawer_chat_toggle'>
          Send Message
        </button>
      </div>
    </div>
