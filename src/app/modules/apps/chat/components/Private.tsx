          ...
          <div className='card-body pt-5' id='kt_chat_contacts_body'>
            ...
            >
              <div className='d-flex flex-stack py-4'>
                <div className='d-flex align-items-center'>
                  <div className='symbol symbol-45px symbol-circle'>
                    <span className='symbol-label bg-light-danger text-danger fs-6 fw-bold'>M</span>
                  </div>
              ...
              <div className='d-flex flex-stack py-4'>
                <div className='d-flex align-items-center'>
                  <div className='symbol symbol-45px symbol-circle'>
                    <span className='symbol-label bg-light-warning text-warning fs-6 fw-bold'>
                      M
                    </span>
                  </div>
                  ...
                  <div className='ms-5'>
                    ...
                    <div className='fw-semibold text-gray-400'>mikaela@pexcom.com</div>
                  </div>
                </div>
              ...
              <div className='d-flex flex-stack py-4'>
                <div className='d-flex align-items-center'>
                  ...
                  <div className='ms-5'>
                    ...
                    <div className='fw-semibold text-gray-400'>f.mitcham@kpmg.com.au</div>
                  </div>
                </div>
              ...
              <div className='d-flex flex-stack py-4'>
                <div className='d-flex align-items-center'>
                  <div className='symbol symbol-45px symbol-circle'>
                    <span className='symbol-label bg-light-danger text-danger fs-6 fw-bold'>O</span>
              ...
              <div className='d-flex flex-stack py-4'>
                <div className='d-flex align-items-center'>
                  <div className='symbol symbol-45px symbol-circle'>
                    <span className='symbol-label bg-light-danger text-danger fs-6 fw-bold'>E</span>
                    <div className='symbol-badge bg-success start-100 top-100 border-4 h-15px w-15px ms-n2 mt-n2'></div>
                  </div>
