      ...
      <form className='form d-flex flex-center'>
        <div className='card-body mw-800px py-20'>
            ...
            <div className='col-lg-9'>
              <div className='d-flex align-items-center'>
                <div className='form-check form-check-custom form-check-solid me-5'>
                  ...
                  />
                  <label className='form-check-label fw-semibold' htmlFor='inlineCheckbox1'>
                    Email
                  </label>
                </div>
                <div className='form-check form-check-custom form-check-solid me-5'>
                  ...
                  />
                  <label className='form-check-label fw-semibold' htmlFor='inlineCheckbox2'>
                    SMS
                  </label>
                </div>
                <div className='form-check form-check-custom form-check-solid'>
                  ...
                  />
                  <label className='form-check-label fw-semibold' htmlFor='inlineCheckbox3'>
                    Phone
                  </label>
                </div>
              </div>
          ...
          <div className='row mb-8'>
            ...
            <div className='col-lg-9'>
              <button type='button' className='btn btn-light-primary fw-semibold btn-sm'>
          ...
          <div className='row mb-13'>
            ...
            <div className='col-lg-9'>
              <div className='form-check form-check-custom form-check-solid me-5'>
                ...
                />
                <label className='form-check-label fw-semibold' htmlFor='customCheck5'>
              ...
              <button type='button' className='btn btn-light-danger fw-semibold btn-sm'>
          ...
          <div className='row'>
            ...
            <div className='col-lg-9'>
              <button type='reset' className='btn btn-primary fw-bold px-6 py-3 me-3'>
                Save Changes
              </button>
              <button
                type='reset'
                className='btn btn-color-gray-600 btn-active-light-primary fw-bold px-6 py-3'
              >
                Cancel
              </button>
            </div>
