        ...
        <div className='card-body mw-800px py-20'>
          <div className='row'>
            ...
            <div className='col-lg-9 col-xl-6'>
              <h5 className='fw-semibold mb-6'>Setup Email Notification:</h5>
            </div>
          </div>

          <div className='mb-5 row align-items-center mb-2'>
            <label className='col-xl-3 col-lg-3 col-form-label fw-semibold text-start text-lg-end'>
              Email Notifications
            </label>
          ...
          <div className='row'>
            <label className='col-xl-3'></label>
            <div className='col-lg-9 col-xl-6'>
              <h5 className='fw-semibold mb-6'>Activity Related Emails:</h5>
            </div>
          </div>
          ...
          <div className='mb-8 row'>
            ...
            <div className='col-lg-9 col-xl-6'>
              <div className='form-check form-check-custom form-check-solid mb-3'>
                ...
                />
                <label
                  className='form-check-label fw-semibold text-gray-600'
          ...
          <div className='row'>
            <label className='col-xl-3'></label>
            <div className='col-lg-9 col-xl-6'>
              <h5 className='fw-semibold mb-6'>Updates From Keenthemes:</h5>
            </div>
          </div>
