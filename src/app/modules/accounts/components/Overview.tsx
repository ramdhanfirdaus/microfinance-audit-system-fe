        ...
        <div className='card-body p-9'>
          <div className='row mb-7'>
            ...
            <div className='col-lg-8'>
              <span className='fw-bold fs-6 text-dark'>Max Smith</span>
            </div>
          </div>
          ...
          <div className='row mb-7'>
            ...
            <div className='col-lg-8'>
              <span className='fw-bold fs-6 text-dark'>Germany</span>
            </div>
          </div>
          ...
          <div className='row mb-7'>
            ...
            <div className='col-lg-8'>
              <span className='fw-bold fs-6 text-dark'>Email, Phone</span>
            </div>
          </div>
          ...
          <div className='row mb-10'>
            ...
            <div className='col-lg-8'>
              <span className='fw-semibold fs-6'>Yes</span>
            </div>
          </div>
            ...
            <div className='d-flex flex-stack flex-grow-1'>
              <div className='fw-semibold'>
                ...
                <div className='fs-6 text-gray-600'>
                  ...
                  <Link className='fw-bold' to='/crafted/account/settings'>
                    {' '}
                    Add Payment Method
                  </Link>
                  .
